...
namespace CSLauncher.Services {
    ...
    public class ClassicubeService {
        ...
        public ClassicubeService(string username, string password) {
            Username = username;
            Password = password;
        ...
        public bool Login() {
            ...
            if (pageData == null)
                throw new InvalidOperationException("Failed to download Classicube.net page.");
